 ...
 * and at the same indent level as roundSum().
 ...
 roundSum(6, 4, 4) → 10
 */
public class LogicTwo5RoundSumSolution {
    public int roundSum(int a, int b, int c) {
        int roundA = (int) (Math.round(a/10.0) *10);
        int roundB = (int) (Math.round(b/10.0) *10);
        int roundC = (int) (Math.round(c/10.0) *10);
